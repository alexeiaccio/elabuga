...
module.exports = {
  ...
  */
  ...
  textSizes: {
    ...
    heading1: 'calc(36px + 12 * ((100vw - 320px) / 1280))',
    heading2: 'calc(32px + 12 * ((100vw - 320px) / 1280))',
    heading3: 'calc(30px + 12 * ((100vw - 320px) / 1280))',
    heading4: 'calc(28px + 12 * ((100vw - 320px) / 1280))',
    heading5: 'calc(21px + 12 * ((100vw - 320px) / 1280))',
    heading6: 'calc(18px + 6 * ((100vw - 320px) / 1280))',
